<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje2MuzikKursuKayit.Default" %>
...
<head>
	<title>Ders Proje 2 Müzik OKulu Kayıt</title>
			...
			<form action="#" method="post" class="agile_form" runat="server">
				...
				<div class="section_class_agileits">
					<asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem>Bateri</asp:ListItem>
